...
questions ={ 
    ...
    'A. Turn it into the police, it is not your money and it is the right thing to do' ...
    ...
    ['7. Your boss asks you to plan a new project and if successful youll get a raise. How do you react?' ...
    'A. You decline the offer. You do not like being in the spotlight and are happy with your job now' ...
    'B. You have already called the president and have big plans for the project' ...
    'C. You have assembled a team and are gathering ideas from everyone']; 
    ['8. You find yourself lost in the woods, how do you proceed?' ...
    'A. You have practiced this before and are ready with your compass at the ready' ...
    'B. You are helping the others remain calm and showing your support' ...
    'C. You have picked a direction and are going for it, theres no going back now'], };
